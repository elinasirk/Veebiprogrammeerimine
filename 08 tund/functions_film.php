<?php
  function readAllFilms(){
	  ...
	  while($stmt->fetch()){
		...
		$filmInfoHTML .= "<p>Žanr: " .$filmGenre .", lavastaja: " .$filmDirector .". Kestus: " .$filmDurationDesc .". Tootnud: " .$filmCompany ." aastal: " .$filmYear .".</p>";
		//echo $filmTitle;
	  }
...
/*   function readAllFilms2(){
	  ...
	  $filmInfoHTML2 .= .$filmYear .".</p>";
	  }
	  $stmt->close();
	  $conn->close();
	  return $filmInfoHTML2;
  } */
